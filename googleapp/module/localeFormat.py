...
:synopsis: provide an alternative method to datetime's strptime, 
              taking an additional two language parameter to 
...
class LocaleFormat:
    ...
    def __init__(self):
        """
        Holds the languges that is provided by the module. 
        More can be added for multilanguage usage.
        """
        self.locale = {
                        "C":
                            {
                                "long": ["january", "february", "march", 
                                        ...
                                        "november", "december"],
                                "short": ["jan", "feb", "mar", "apr", 
                                        "may", "jun", "jul", "aug", 
                                        "sep", "oct", "nov", "dec"]
                            },
                        "da_DK": 
                            {
                                "long": ["januar", "februar", "marts", "april", 
    ...
    def strptime(self, dateString, format, langFrom, langTo):
        ...
        Args:
            dateString (str) - a string describing a date. 
                E.g. "20. Okt 2013, 18:43"
            format (str) - a string describing the format of the dateString. 
                E.g. '%d. %b %Y, %H:%M'
            langForm (str) - the dateString langeuge in locale format.
                E.g. "da_DK"
            langto (str) - the lange to which the string should 
                be parsed in locale format. E.g. "C"

        Returns:
            (datetime) A datetime object initialized with the 
                time specified be the arguments
        """
    ...
    def localeFormat(self,  dateString, format, langFrom, langTo):
        """Converts the international date string to a date 
                string in any other language

        Args:
            dateString (string) - a string describing a date. 
                E.g. "20. Okt 2013, 18:43"
            format (string) - a string describing the format of the dateString. 
                E.g. '%d. %b %Y, %H:%M'
            langForm - the dateString langeuge in locale format. 
                E.g. "da_DK"
            langto - the lange to which the string should be parsed in locale format. 
                E.g. "C"
...
if __name__ == "__main__":
    ...
    print args
    lf = LocaleFormat()
    print lf.strptime(args[1], args[2], args[3], args[4])
